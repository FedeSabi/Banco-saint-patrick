...
const UniteASaintPatrick = () => {
  return (
    ...
    <div className='flex xs:flex-col xl:flex-row  xs:justify-center xl:justify-evenly'>
        ...
        {/*divisor texto */}
        <div className=' text-customGreen xs:w-[380px] xl:w-[520px] flex flex-col xl:justify-around xs:ml-2 mt-20 gap-2'>
          ...
          <div className='font-bold mb-20' >
            <p className='xs:text-lg xs:text-center xl:text-3xl mb-10'>Postulate a nuestras busquedas y potencia lo mejor de vos</p>
            <p className='xs:text-lg  xs:text-center xl:text-3xl'>Banco Saint Patrick te alienta a pensar en grande.</p>
          </div>
