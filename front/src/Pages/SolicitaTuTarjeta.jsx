    ...
    {/*primera seccion */}
      ...
      <div className=" w-full h-auto flex flex-col">
        <div className="ml-48">
          ...
          <p className="text-black w-[700px] text-2xl font-bold">
          ...
          <button className="rounded-[15px] w-[441px] h-[59px] mb-20 bg-customYellow text-black font-semibold text-[25px]">
            Quiero mi tarjeta
        </button>
          </div>
        </div>
