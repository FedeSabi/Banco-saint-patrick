...
const HomeTarjetas = (nombre) => {
    ...
    return (
        <div className='bg-customBg '>
            ...
            <div className="bg-customBg  w-full min-h-[63vh] mt-[30px] sm:min-h-[63vh] sm:mt-[9%] md:min-h-[54vh] md:mt-[9%]  lg:min-h-[63vh] xl:min-h-[63vh] xl:mt-[2rem] flex justify-center items-center md:items-stretch">



                <div className=" flex justify-around w-full flex-wrap bg-customBg ">
                    <div>
                        ...
                        <div className="w-full h-[270px] sm:h-[280px] md:h-[425px] lg:h-[353px] xl:h-[400px]  2xl:h-[400px] rounded-[1.35rem] relative text-white shadow-2xl transition-transform transform hover:scale-110">
                            ...
                            <div className="w-full px-8 absolute top-1 h-[270px] sm:h-[280px] md:h-[425px] lg:h-[400px] xl:h-[400px]  2xl:h-[383px] flex flex-col justify-around">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <img className="mt-5 w-10 h-15 sm:w-[2rem] sm:h-[4rem] md:w-[6rem] md:h-[8rem] lg:w-24 lg:h-[8rem] xl:w-24 xl:h-[8rem] 2xl:w-24 2xl:h-[8rem]" src={logo} />
                                </div>
                                <div className="pt-1">
                                    <div className="w-[96px] ">
                                        <img className="w-10 h-15 sm:w-[2rem] sm:h-[2rem] md:w-[3rem] md:h-[3rem] lg:w-[2.5rem] lg:h-[2.5rem] xl:w-[2.5rem] xl:h-[2.5rem] 2xl:w-12 2xl:h-[3rem]" src={chip} alt="" />
                                    </div>
                                    <div className="flex justify-center">
                                        <p className="font-[200] tracking-more-wider w-full text-[35px] sm:text-[20px] md:text-[3.9rem] lg:text-[3.7rem] xl:text-[3.8rem] 2xl:text-[3.8rem]">
                                            4642 3489 9867 7632
                                        </p>
                                    </div>
                                </div>
                        ...
                        <form className=" my-[2rem] sm:my-[2rem] md:my-[2rem] lg:my-[4.5rem] xl:my-[2.5rem] 2xl:my-[3.5rem] mx-1" action="">
            ...
            <div className='flex justify-center items-center sm:h-[28px] md:h-[250px] lg:h[33px] xl:h-[63px] 2xl:h-[109px]'>
                <Link to={'/historial'}>
                    <button type="submit" className="w-full w-[300px] sm:w-[500px] 2xl:w-[564px] bg-customYellow font-custom font-simibold text-black text-xl sm:text-1xl px-4 py-2 rounded-lg hover:bg-[#E1A000] focus:outline-none  focus:ring-opacity-50">Histotial de transaciones</button>
                </Link>
            </div>
