      ...
      <footer className="w-full text-gray-700 bg-gray-100 body-font">
        <div className="container flex flex-col flex-wrap px-5 py-14 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
          <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
            <img src={logo} alt="Logo" className="sm:ml-4 md:ml-[280px] lg:ml-10 mb-4 w-24 h-28 ml-20" />
          </div>
          <div className="flex flex-wrap flex-grow mt-10 lg:ml-6 text-center md:pl-20 md:mt-0 md:text-left">
