...
function NavbarInterno() {
  return (
    <div className="xs:flex-col xl:flex-row flex max-w-full xs:h-48 xs:mt-14 xl:h-12 bg-customGreen border-customYellow border-2 justify-around items-center font-semibold">
